...
<a target="_blank" href="{{ "/events/locandina-linux-day-2015.jpg" | prepend: site.img_url }}" style="display: flex; align-items: center; justify-content: center; padding: 20px 0;">
    <img src="{{ "/events/locandina-linux-day-2015.jpg" | prepend: site.img_url }}" width="400" />
</a>